...
第 17 届电子赛环境配置说明与资源数据包暂未发布，当前可参考 [第 16 届环境配置说明](https://dasai.lanqiao.cn/notices/1756)、[第 16 届资源数据包](https://dasai.lanqiao.cn/notices/1096)。
...
[第 16 届资源数据包](https://dasai.lanqiao.cn/notices/1096) 的 I2C 驱动存在已知问题，停止位稳定时间过短，导致 E2PROM 连续读写偶发失败，应修改以下源文件解决（即将 `I2C_Stop` 函数末尾等待时间加长至原有 1000 倍）：
