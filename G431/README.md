...
2026 年嵌入式赛道环境配置与资源数据包尚未发布，目前可参考 2025 年 [环境配置](https://dasai.lanqiao.cn/notices/1756) 与 [资源数据包](https://dasai.lanqiao.cn/notices/1096)。

2025 年资源数据包提供的 I2C 驱动可能存在对 E2PROM 连续读写错误的问题，建议将`void I2CStop(void)`函数末尾等待时间延长至 1000 倍以上，即将最后一处`delay1(DELAY_TIME);`修改为`delay1(DELAY_TIME * 1000);`
